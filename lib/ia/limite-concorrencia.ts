 ...
 * auditoria de peça, advogado do contra, estrategista jurídico) quando o gate de concorrência por escritório barra uma
 ...
 * somando as 6 tabelas que hoje modelam esse tipo de job. Generalização do
 ...
 *
 * 6 `count` queries em paralelo (`Promise.all`) em vez de 1 query só — as 6
