...
export function AdminSidebar({
  ...
  return (
    <>
      <header className="sticky top-0 z-30 flex h-14 shrink-0 items-center gap-3 border-b border-amber-500/20 bg-navy/95 px-4 backdrop-blur-md md:hidden">
        <button
          type="button"
        ...
        <span className="truncate font-display text-sm font-semibold text-amber-300">Painel Admin</span>
      </header>
