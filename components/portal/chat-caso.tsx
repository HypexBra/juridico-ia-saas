...
import { enviarMensagemClienteAction } from "@/app/portal/mensagens/actions";
...
/**
 * Chat do cliente com o escritório (feature Pro "portal_cliente_rico").
 * Recebe o histórico inicial já carregado pelo Server Component (evita um
 * segundo round-trip só pra montar a tela) e assina Realtime só para
 * eventos NOVOS a partir daí.
 */
export function ChatCaso({
  ...
  function handleEnviar() {
    ...
    startTransition(async () => {
      const resultado = await enviarMensagemClienteAction(fichaId, texto);
      if (!resultado.ok) {
