...
// Adaptado de React Bits (BorderGlow, variante JS-CSS) — https://reactbits.dev/components/border-glow
// Efeito puramente visual (CSS custom properties seguindo o cursor), sem
// dependência externa nem chamada de rede. Convertido pra TSX/tipado pra
// manter o padrão estrito do resto do projeto.
