...
export function CtaFinal() {
  return (
    <section className="relative overflow-hidden bg-navy py-24 sm:py-28">
      <div
        aria-hidden
        className="cta-glow pointer-events-none absolute left-1/2 top-1/2 h-[380px] w-[780px] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-70 blur-3xl"
      ...
      <div className="relative mx-auto max-w-3xl px-5 text-center sm:px-8">
        <TextReveal
          as="h2"
          trigger="scroll"
          className="block font-display text-3xl font-black leading-tight text-ice sm:text-4xl lg:text-5xl"
        >
