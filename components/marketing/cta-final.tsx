    ...
    <section className="relative overflow-hidden py-24 sm:py-28">
      ...
      <div className="mx-auto grid max-w-6xl grid-cols-1 items-center gap-14 px-5 sm:px-8 lg:grid-cols-[1.1fr_0.8fr]">
        ...
        <Reveal delayMs={200} className="lg:justify-self-end">
          <div className="relative max-w-xs border-l-2 border-gold/40 pl-6">
            <span
              aria-hidden
              className="absolute -left-3 -top-8 select-none font-display text-7xl font-black text-gold/15"
            >
              §
            </span>
